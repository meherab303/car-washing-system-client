    ...
    <div className="container mx-auto p-6">
      <div className="bg-gray-300 shadow-lg p-6 rounded-lg">
        ...
        <p className="text-gray-600 mb-3">
          We collect personal data such as your name, email, and payment details
        ...
        <p className="text-gray-600 mb-3">
          We use your data to improve our services and process transactions
          securely.
        </p>
        <h3 className="text-xl text-black font-semibold">3. Contact Us</h3>
        <p className="text-gray-600">
          If you have any concerns about your privacy, reach out to
          privacy@carwash.com.
        </p>
      </div>
    </div>
