...
const CarServiceCard = ({ service }: { service: TService }) => {
  ...
  return (
    <Card className="w-full max-w-[320px] p-3 shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
      ...
      <CardFooter className="flex justify-between items-center">
        ...
        <Button
          className="bg-transparent hover:bg-slate-800 hover:text-white"
          radius="full"
          size="sm"
          variant="bordered"
